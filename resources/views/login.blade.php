	...
	<div class="row justify-content-center">
		...
		<div class="kt-login__container center-block" >
				<div class="kt-login__logo" style="margin-top: 11vh">
					<a href="#">
						<img src="{{asset('./assets/media/logos/logolavin.png')}}"/>
					</a>
			</div>
		</div>
		</div>
						...
						<div class="row justify-content-center">
							...
							<div class="col-12 col-md-4">
									<div class="input-group">
										<input class="form-control" type="text" style="border-radius:15px" placeholder="Usuario" name="email" autocomplete="off" required>
									</div>
									<br>
									<div class="input-group">
							...
							<br><br><em><strong><h3 align="center" style="color: red">"Somos confianza y seguridad"</h3></strong></em>
							</div>	
