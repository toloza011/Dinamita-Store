...
Route::group(['middleware'=>'admin','prefix'=>'Admin'],function(){
    ...
    Route::post('Admin/updaSus/{id}', ['uses' => 'SuscripcionesController@updateSus'])->name('updateSus');
    Route::get('Admin/CrearSus','SuscripcionesController@agregar')->name('createSus');
